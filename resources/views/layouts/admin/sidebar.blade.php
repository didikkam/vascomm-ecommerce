...
<div class="sidebar col-auto col-md-3 col-xl-2 px-0 bg-white mt-1">
        ...
        <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu"
            ...
            <li class="nav-item {{ Route::is('admin.index') ? 'active' : '' }}">
                <a href="{{ route('admin.index') }}" class="nav-link align-middle">
                    <img src="{{ Route::is('admin.index') ? asset('assets/images/ic_dashboard_active.png') : asset('assets/images/ic_dashboard.png') }}"
                        alt="Logo" height="25">
            ...
            <li class="nav-item {{ Route::is('admin.users.*') ? 'active' : '' }}">
                <a href="{{ route('admin.users.index') }}" class="nav-link align-middle">
                    <img src="{{ Route::is('admin.users.*') ? asset('assets/images/ic_user_active.png') : asset('assets/images/ic_user.png') }}"
                        alt="Logo" height="25">
            ...
            <li class="nav-item {{ Route::is('admin.products.*') ? 'active' : '' }}">
                <a href="{{ route('admin.products.index') }}" class="nav-link align-middle">
                    <img src="{{ Route::is('admin.products.*') ? asset('assets/images/ic_product_active.png') : asset('assets/images/ic_product.png') }}"
                        alt="Logo" height="25">
